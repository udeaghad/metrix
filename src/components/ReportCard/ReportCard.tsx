...
const ReportCard = ({Icon, iconColor, iconBgColor, cardBgColor, reportRange, handleChange, showRangeSelector, data, titleColor}: ReportcardProps) => {
  ...
  return (
    <Box sx={{backgroundColor: cardBgColor, border: "1px solid white", p: 1, borderRadius: "1rem" }}>
      <Box 
        sx={{
      ...
      {showRangeSelector &&
        <Box sx={{ minWidth: 80, top: 0, right: 0 }}>
          <form>
            <select
              id="shop"
              ...
              style={{backgroundColor: "inherit", border: "1px #eeeeee solid", borderRadius: "5px", padding: "3px", fontSize: "1rem"}}
            >              
      ...
      <Box sx={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
        <Box sx={{width: "50%"}}>          
          ...
          <Box sx={{display: "flex", gap: "2px", justifyContent: "center", alignItems: "center"}}>
            <Typography variant="subtitle1" sx={{ flexGrow: 1, color: cardBgColor = "white" ? "green" : "white"}}>{data.value}</Typography>
        ...
        <Box sx={{width: "23%"}}>
          <Typography variant="caption" sx={{ flexGrow: 1, color: titleColor }}>{data.property1}</Typography>
          <Box sx={{display: "flex", gap: "2px", justifyContent: "center", alignItems: "center"}}>
            <Typography variant="subtitle1" sx={{ flexGrow: 1, color: cardBgColor = "white" ? "green" : "white"}}>{data.property1Value}</Typography>
        ...
        <Box sx={{width: "22%"}}>
          ...
          <Box sx={{display: "flex", gap: "2px", justifyContent: "center", alignItems: "center"}}>
            <Typography variant="subtitle1" sx={{ flexGrow: 1, color: cardBgColor = "white" ? "green" : "white"}}>{data.property2Value}</Typography>
